...
export default function Header({ isAdmin }: { isAdmin?: boolean }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-cream/90 backdrop-blur-md border-b border-terracotta/10 dark:bg-charcoal/90 dark:border-terracotta/10 transition-colors duration-300">
            ...
            {isCurrentlyAdmin ? (
              ...
              <>
                ...
                {status === "authenticated" ? (
                  ...
                  <NavLink href="/login" variant="button" size="md" className="flex items-center gap-2">
