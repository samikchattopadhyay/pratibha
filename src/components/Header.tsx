...
export default function Header({ isAdmin }: { isAdmin?: boolean }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-cream/90 backdrop-blur-md border-b border-terracotta/10 dark:bg-charcoal dark:border-terracotta/10 transition-colors duration-300">
